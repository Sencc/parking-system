		...
		<div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<img alt="" style="width: 300px;height: 300px;margin-left: 20%" src="${APP_PATH }/pic/zhifubao.jpg">
					</div>
					<div id="pay_wx" hidden="hidden">
					<h4>微信：<span id="wx_text"></span>元</h4>
					<img alt="" style="width: 300px;height: 300px;margin-left: 20%" src="${APP_PATH }/pic/wechat.jpg">
					</div>
